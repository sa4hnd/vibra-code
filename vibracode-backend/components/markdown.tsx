...
export const CodeComponent: React.FC<CodeComponentProps> = ({
  ...
  if (match) {
    return (
      <div className="border rounded-lg border-muted-foreground/20 my-2 bg-sidebar overflow-hidden max-w-full">
...
const NonMemoizedMarkdown = ({ children }: { children: string }) => {
  return (
    <div className="w-full overflow-hidden" style={{ maxWidth: "100%", contain: "inline-size" }}>
      <ReactMarkdown
