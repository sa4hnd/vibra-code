import { Sparkles, CircleDot, Layers } from 'lucide-react-native';
...
const OPTIONS = [
  {
    id: 'new_concept',
    label: 'New concept',
    subtitle: 'Nothing like it exists',
    icon: Sparkles,
  },
  {
    id: 'fresh_spin',
    label: 'Fresh spin',
    subtitle: 'A new take on a familiar app',
    icon: CircleDot,
  },
  {
    id: 'close_remake',
    label: 'Close remake',
    subtitle: 'Building a proven idea',
    icon: Layers,
  },
];

export const NewOnboardingScreen6: React.FC<NewOnboardingScreen6Props> = ({ onNext, onBack }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Which option best describes the app you want to build?</Text>
...
export default NewOnboardingScreen6;
