...
+      "url": "https://www.vibracodeapp.com/api/manifest"
     }
   }
 }
```
...
+ <meta-data android:name="expo.modules.updates.EXPO_UPDATE_URL" android:value="https://www.vibracodeapp.com/api/manifest"/>
 </application>
```
...
<plist version="1.0">
  <dict>
    ...
    <string>https://www.vibracodeapp.com/api/manifest</string>
  </dict>
</plist>
```
